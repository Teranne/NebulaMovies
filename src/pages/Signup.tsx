      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="auth-form">
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold mb-2 nebula-text-gradient">Create an Account</h1>
            <p className="text-white/60">Sign up to get started with NebulaMovies</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-white/60">
              ...
              <Link to="/login" className="text-nebula-accent hover:underline">
                Sign in
              </Link>
            </p>
          </div>
